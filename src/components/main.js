      ...
      >
        ...
        <Link href="/hoteles" className={styles.grid__item1}>
          <div className={styles.grid__info}>
            ...
            <p className={styles.info__p}>
              ¿Buscas hospedaje? Checa nada más brody estas sugerencias que
              tenemos para ti.
            </p>
        ...
        <Link href="/servicios" className={styles.grid__item3}>
          <div className={styles.grid__info}>
            ...
            <p className={styles.info__p}>
              ¿Buscas un buen fotógrafo, mecánico, dentista o un salón que te
              permita celebrar ese evento especial??
            </p>
            <p className={styles.info__p}>
        ...
        <Link href="/nuestraGaleria" className={styles.grid__item4}>
          <div className={styles.grid__info}>
            ...
            <p className={styles.info__p}>¡Acapulco!</p>
          </div>
        </Link>
