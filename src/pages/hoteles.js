          ...
          <div className={styles.card__wrapper}>
            {hotels.map((hotel) => (
              <Card
                key={hotel.id}
                path={'hoteles'}
                image={hotel.attributes.imagenes.data[0].attributes.formats.small.url}
                width={hotel.attributes.imagenes.data[0].attributes.formats.small.width}
                height={hotel.attributes.imagenes.data[0].attributes.formats.small.height}
